...
import com.hypers.hm.adb.AdbProtocol.ADB_AUTH_RSAPUBLICKEY
import com.hypers.hm.adb.AdbProtocol.ADB_AUTH_SIGNATURE
import com.hypers.hm.adb.AdbProtocol.ADB_AUTH_TOKEN
import com.hypers.hm.adb.AdbProtocol.A_AUTH
import com.hypers.hm.adb.AdbProtocol.A_CLSE
import com.hypers.hm.adb.AdbProtocol.A_CNXN
import com.hypers.hm.adb.AdbProtocol.A_MAXDATA
import com.hypers.hm.adb.AdbProtocol.A_OKAY
import com.hypers.hm.adb.AdbProtocol.A_OPEN
import com.hypers.hm.adb.AdbProtocol.A_STLS
import com.hypers.hm.adb.AdbProtocol.A_STLS_VERSION
import com.hypers.hm.adb.AdbProtocol.A_VERSION
import com.hypers.hm.adb.AdbProtocol.A_WRTE
...
class AdbClient(private val host: String, private val port: Int, private val key: AdbKey) : Closeable {
    ...
    fun connect() {
        ...
        if (message.command == A_STLS) {
            // BuildUtils.atLeast29 (rikka) replaced with direct SDK check
